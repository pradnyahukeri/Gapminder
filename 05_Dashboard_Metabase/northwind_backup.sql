...
CREATE TABLE public.customer (
    ...
    customer_address character varying(50),
...
COPY public.categories (category_id, category_name, cat_description, picture) FROM stdin;
...
COPY public.customer (customer_id, company_name, contact_name, contact_title, customer_address, city, region, postal_code, country, phone, fax) FROM stdin;
...
COPY public.employee (employee_id, last_name, first_name, title, title_of_courtesy, birth_date, hire_date, employee_address, city, region, postal_code, country, home_phone, extension, photo, notes, reports_to, photo_path) FROM stdin;
...
COPY public.shipper (shipper_id, company_name, phone) FROM stdin;
...
COPY public.supplier (supplier_id, company_name, contact_name, contact_title, supplier_address, city, region, postalcode, country, phone, fax, homepage) FROM stdin;
